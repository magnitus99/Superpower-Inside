...
const ko: I18nKeys = {
  ...
  sourceVerifiedCount: '검증된 근거 {count}개',
  sourceSearchVerifiedCount: '검색 근거 {verified}/{total}개 검증',
  sourceOpenAction: '열기',
  ...
  settingsAuto045: 'ℹ️ 예상 비용 상세 보기',
  settingsAuto046: 'ℹ️ 예상 비용 상세 숨기기',
  ...
  settingsAuto181: '인덱싱 제외 대상',
  settingsAuto182: '고급 인덱싱 옵션',
  ...
  sourceUnverifiedIdWarning: '이번 응답의 검증된 검색 근거에 없는 출처 ID입니다.',
  sourceMissingVaultLinkWarning: 'vault에서 확인되지 않은 문서 링크입니다.',
...
const en: I18nKeys = {
  ...
  sourceVerifiedCount: '{count} verified sources',
  sourceSearchVerifiedCount: '{verified}/{total} search sources verified',
  ...
  settingsAuto026: 'Advanced settings/diagnostics',
  ...
  settingsAuto163: 'Indexing controls',
  ...
  settingsAuto181: 'Indexing exclusions',
  settingsAuto182: 'Advanced indexing options',
  ...
  settingsAuto198: 'Search quality',
  ...
  sourceUnverifiedIdWarning:
    'This source ID is not in the verified search evidence for this response.',
  sourceMissingVaultLinkWarning: 'This document link could not be verified in the vault.',
